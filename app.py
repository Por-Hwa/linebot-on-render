...
def handle_message(event):
    ...
    if any(k in user_input for k in ["inbody", "身理指數介紹"]):
        images = [
            ImageSendMessage(original_content_url=url, preview_image_url=url) for url in [
    ...
    if any(k in user_input for k in ["介紹"]):
        images = [
            ImageSendMessage(
                ...
                preview_image_url='https://i.postimg.cc/kGxX8gyp/Inbody1.png'
            ),
            ImageSendMessage(
                original_content_url='https://i.postimg.cc/hG6S5dyY/Inbody2.png',
                preview_image_url='https://i.postimg.cc/hG6S5dyY/Inbody2.png'
            ),
            ImageSendMessage(
                original_content_url='https://i.postimg.cc/h49S2h9C/Inbody3.png',
                preview_image_url='https://i.postimg.cc/h49S2h9C/Inbody3.png'
            ),
            ImageSendMessage(
                original_content_url='https://i.postimg.cc/Vv1PxBjK/Inbody4.png',
                preview_image_url='https://i.postimg.cc/Vv1PxBjK/Inbody4.png'
            ),
            ImageSendMessage(
                original_content_url='https://i.postimg.cc/pTbwjY1P/Inbody5.png',
                preview_image_url='https://i.postimg.cc/pTbwjY1P/Inbody5.png'
            )
        ]
        line_bot_api.reply_message(event.reply_token, images)
        return
    ...
    if re.search(r"\d+.*蛋白質", user_input):
        reply = "已記錄您今天攝取的蛋白質。"
    elif any(keyword in user_input for keyword in ["你好", "體重"]):
